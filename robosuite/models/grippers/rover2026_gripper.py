...
class Rover2026GripperBase(GripperModel):

    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/rover2026_gripper.xml"), idn=idn)
    ...
    def _important_geoms(self):
        ...
        # Match the geoms we defined in rover2026_gripper.xml.
        return {
...
class Rover2026Gripper(Rover2026GripperBase):
    def format_action(self, action):
        assert len(action) == 1
